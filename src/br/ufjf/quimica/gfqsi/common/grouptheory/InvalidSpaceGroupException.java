 ...
 * @version $Id: InvalidSpaceGroupException.java,v 1.4 2008-12-15 12:06:48 aryjr Exp $
 *
 */
public class InvalidSpaceGroupException extends Exception {

    public static final String CVS_REVISION = "$Revision: 1.4 $";

    public InvalidSpaceGroupException(final String message) {
        super(message);
    }
}
/**
 * $Log: InvalidSpaceGroupException.java,v $
