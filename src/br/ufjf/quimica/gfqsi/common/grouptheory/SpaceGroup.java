 ...
 * @version $Id: SpaceGroup.java,v 1.4 2008-12-15 12:06:48 aryjr Exp $
 *
 */
public class SpaceGroup {
    ...
    private ArrayList<SymmetryOperation> symops = new ArrayList();
    ...
    public void addSymmetryOperation(SymmetryOperation symop) {
        symops.add(symop);
    }

    public SymmetryOperation getSymmetryOperation(int ind) {
