 ...
 * @version $Id: MatrixMultiplicationException.java,v 1.5 2008-12-15 12:06:47 aryjr Exp $
 *
 */
public class MatrixMultiplicationException extends Exception {
    ...
    public MatrixMultiplicationException(final String message) {
        super(message);
    }
}
/**
 * $Log: MatrixMultiplicationException.java,v $
